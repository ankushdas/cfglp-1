...
ast_Ptr sym_Entry::get_Sym_Entry_Ptr()
{
	CHECK_INVARIANT(SHOULD_NOT_REACH, "get_Sym_Entry_Ptr() cannot be called for this subclass of sym_Entry")
}

void sym_Entry::set_Sym_Entry_Ptr(ast_Ptr p)
{
	CHECK_INVARIANT(SHOULD_NOT_REACH, "set_Sym_Entry_Ptr() cannot be called for this subclass of sym_Entry")
}
...
new implementation
*/
sym_Entry_for_Float_Var::sym_Entry_for_Float_Var(string s, int line, var_Type v)
{
    name = s;
    var_t= v;
    en_type = entity_Var;
